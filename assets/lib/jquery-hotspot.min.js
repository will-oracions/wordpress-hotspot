...
(function ($) {
	var defaults = {
		...
		schema: [
			...
			},
			{
				property: "Message",
				default:
					"This jQuery Plugin lets you create hotspot to any HTML element. ",
			},
		],
	};
	...
	Hotspot.prototype.displaySpot = function (hotspot, unsaved) {
		...
		var spot = $("<div/>", {
			...
			.css({
				top:
					(hotspot.y * height) / 100 + (offset.top - parent_offset.top) + "px",
				left:
					(hotspot.x * width) / 100 + (offset.left - parent_offset.left) + "px",
			})
